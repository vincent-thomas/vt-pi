...
export const COMMAND_POLICY_ENTRIES: CommandPolicyEntry[] = [
	...
	{ name: "nix", status: CommandPolicyStatus.Allowed, command: "nix", subcommand: [["build"], ["flake"]] },
	{
		name: "git status",
	...
	{ name: "git log", status: CommandPolicyStatus.Allowed, command: "git", subcommand: [["log"]] },
	{ name: "git show", status: CommandPolicyStatus.Allowed, command: "git", subcommand: [["show"]] },
	{ name: "git branch", status: CommandPolicyStatus.Allowed, command: "git", subcommand: [["branch"]] },
	{ name: "git ls-files", status: CommandPolicyStatus.Allowed, command: "git", subcommand: [["ls-files"]] },
	{ name: "git add", status: CommandPolicyStatus.Allowed, command: "git", subcommand: [["add"]] },
	{ name: "git restore", status: CommandPolicyStatus.Allowed, command: "git", subcommand: [["restore"]] },
	{
		name: "git checkout",
		status: CommandPolicyStatus.Allowed,
		command: "git",
